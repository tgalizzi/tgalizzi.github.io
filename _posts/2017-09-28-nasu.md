...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.html path="assets/img/nasu/map.jpg" title="example image" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/chambre_trad.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
