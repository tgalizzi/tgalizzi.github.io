...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.html path="assets/img/nasu/map.pnh" title="example image" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        <p> Nasu (那須町 ) est un bourg japonais situé dans le district de Nasu, dans préfecture de Tochigi, au nord de Tokyo. </p>
    </div>
</div>
